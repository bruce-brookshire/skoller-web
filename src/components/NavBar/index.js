...
class NavBar extends React.Component {
  ...
  renderClassInfo () {
    const {userStore: {user}, navbarStore: {cl, isDIY, approveClass, toggleEditCl, toggleIssues, toggleHelpResolved, toggleRequestResolved, toggleWrench}} = this.props.rootStore
