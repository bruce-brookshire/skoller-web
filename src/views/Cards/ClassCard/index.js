...
class ClassCard extends React.Component {
  ...
  render () {
    const {cl, schoolName, semesterName, professorName, isAdmin, boxClassName, contentClassName} = this.props

    return (
      <div className={'cn-class-card ' + boxClassName}>
        <div className={'cn-class-card-content ' + contentClassName}>
