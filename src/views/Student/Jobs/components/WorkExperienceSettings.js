...
class WorkExperienceSettings extends React.Component {
  constructor (props) {
    super(props)
  ...
  render () {
    ...
    let workExperiences = profile.experience_activities
    return (
      <div className='jobs-form-container'>
        {this.props.rootStore.studentJobsStore.profile.experience_activities.map(e => {
          return (
            <div key={workExperiences.indexOf(e)} className='jobs-form-row'>
              ...
              {this.state.editing === e.id &&
                <div style={{border: '1px solid #4a4a4a', borderRadius: '5px', backgroundColor: 'rgba(0,0,0,0.02)'}}>
                  <ExperienceForm editingExperience={e} isVolunteer={false} onSubmit={() => {
                    this.props.onSubmit()
...
WorkExperienceSettings.propTypes = {
  isVolunteer: PropTypes.bool,
  rootStore: PropTypes.object,
  onSubmit: PropTypes.func
}

export default WorkExperienceSettings
