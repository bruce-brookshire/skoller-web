...
import {
  ...
  CardNumberElement, CardExpiryElement, CardCvcElement, StripeProvider
...
export default function CheckoutForm(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!stripe || !elements) {
      // stripe('pk_test_51JV9OSSGLvMTa3qVnwhFxc03IiK5JOGO94YQufQumo21gTgUAdpvMtEGYH9dgH1BPFrrirHuNbiVbE49gPNHHxIU00WpzV3KLP');
