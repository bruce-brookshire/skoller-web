  ...
  render () {
    return (
      <div className='section-community-feature'>
        <h2 className='section-topper section-header'>Plus, a <span className='blue-text'>community</span> you can't find anywhere else.</h2>
        <div className='row'>
          ...
          <div className='col-xs-12 col-sm-6'>
            <p>As the semester goes on, your class schedules are bound to change.
              ...
              When one student adjusts their schedule on Skoller, all classmates get a notification with the option to copy or dismiss the change.
            </p>
