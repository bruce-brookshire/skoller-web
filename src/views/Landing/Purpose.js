...
class Purpose extends React.Component {
  render () {
    return (
      <div className='even-sections section-slant purpose-section'>
        <span className='blue-section-text section-text section-topper'>ClassNav crowdsources the classroom</span>
