      ...
      <React.Fragment>
        {classes.map(cl => {
          ...
          return (
            ...
            >
              <div className='cn-class-list-cell-title' style={cl.status.id !== 1400 ? {backgroundColor: 'rgb(206, 206, 206)'} : {backgroundColor: color}}>
        ...
        {classes.length % 3 <= 2 && classes.length % 3 > 0 && <div className='cn-class-list-cell empty' />}
        {classes.length % 3 === 1 && <div className='cn-class-list-cell empty' />}
      </React.Fragment>
    )
  }
